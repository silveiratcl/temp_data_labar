...
IC2<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/IC.csv",header=TRUE,sep=";", dec=",")
TS<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/TS.csv",header=TRUE,sep=";", dec=",")
FA<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/FA.csv",header=TRUE,sep=";", dec=",")
DE<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/DE.csv",header=TRUE,sep=";", dec=",")
AR<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/AR.csv",header=TRUE,sep=";", dec=",")

IG<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/IG.csv",header=TRUE,sep=";", dec=",")

RN<-read.csv("C:/Users/lilas/OneDrive/Documents/césure/stage césure/recherche/les coraux/Stage florianopolis/temp_data/temp_data_labar/Temp_DATA/RN.csv",header=TRUE,sep=";", dec=",")
...
## get temp information by site => utiliser round pour avoir 2 décimales
